...
public class Contrato {
    ...
    private String data_confirma_recebimento;
    private String nome_usu2;
    private String nome_usu1;
    
    
	public String getData_confirma_recebimento() {
		return data_confirma_recebimento;
	}
	public void setData_confirma_recebimento(String data_confirma_recebimento) {
		this.data_confirma_recebimento = data_confirma_recebimento;
	}
